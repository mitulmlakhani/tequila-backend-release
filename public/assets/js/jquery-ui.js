...
!(function (t) {
    ...
    (e = t.cleanData),
        ...
        (t.widget.extend = function (e) {
            for (
                var s, n, r = o.call(arguments, 1), a = 0, l = r.length;
                a < l;
                a++
            )
                for (s in r[a])
        ...
        (t.Widget.prototype = {
            ...
            option: function (e, s) {
                ...
                if ("string" == typeof e) {
                    if (
                        ((r = {}), (e = (i = e.split(".")).shift()), i.length)
                    ) {
                        for (
                            n = 0,
                                o = r[e] = t.widget.extend({}, this.options[e]);
                            n < i.length - 1;
                            n++
                        )
                            (o[i[n]] = o[i[n]] || {}), (o = o[i[n]]);
            ...
            _classes: function (e) {
                ...
                function o(o, n) {
                    ...
                    for (a = 0; a < o.length; a++)
                        (r = i.classesElementLookup[o[a]] || t()),
                            e.add
                                ? ((function () {
                                      var s = [];
                                  ...
                                  (r = t(
                                      t.uniqueSort(
                                          r.get().concat(e.element.get())
                                      )
                                  )))
                                : (r = t(r.not(e.element).get())),
                            (i.classesElementLookup[o[a]] = r),
                            s.push(o[a]),
                            n && e.classes[o[a]] && s.push(e.classes[o[a]]);
                }
                return (
                    (e = t.extend(
                        {
            ...
            _untrackClassesElement: function (e) {
                ...
                t.each(s.classesElementLookup, function (i, o) {
                    -1 !== t.inArray(e.target, o) &&
                        (s.classesElementLookup[i] = t(o.not(e.target).get()));
                }),
            ...
            _on: function (e, s, i) {
                ...
                "boolean" != typeof e && ((i = s), (s = e), (e = !1)),
                    i
                        ...
                        : ((i = s), (s = this.element), (o = this.widget())),
                    t.each(i, function (i, r) {
                        function a() {
                            if (
                                ...
                                return ("string" == typeof r ? n[r] : r).apply(
                                    n,
                                    arguments
                                );
                        }
            ...
            _mouseCapture: function (e) {
                ...
                return (
                    ...
                    !!this.handle &&
                        ...
                        this._blockFrames(
                            !0 === s.iframeFix ? "iframe" : s.iframeFix
                        ),
                        !0))
                );
            },
                    ...
                    (i = (s = t(o.containment))[0]) &&
                        ...
                        (this.containment = [
                            ...
                            (e
                                ...
                                : i.offsetHeight) -
                                (parseInt(s.css("borderBottomWidth"), 10) ||
                                    0) -
                    ...
                    (n.positionAbs = i.positionAbs),
                        ...
                        o
                            ? (n.isOver ||
                                  ...
                                  (n.fromOutside = i)),
                              n.currentItem &&
                                  (n._mouseDrag(e), (s.position = n.position)))
                            : n.isOver &&
                              ((n.isOver = 0),
