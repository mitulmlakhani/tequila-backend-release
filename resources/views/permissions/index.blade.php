      ...
      <div class="col-12 col-md-12 col-lg-12">
        <div class="main-heading">
          <h4>{{$panel}} Management</h4>
            ...
            <a class="d-none" href="{{ route($base_route.'.create') }}" data-bs-toggle="modal" data-bs-target="#addRole" data-bs-whatever="@mdo">Add {{$panel}}</a>
            @endcan
        </div>
      </div>
              ...
              <tr>
                ...
                <td class="d-none">
                  ...
                  <span>
                    ...
                    <span>
                        @can($permission_prefix.'-delete')
                        {!! Form::open(['method' => 'DELETE','route' => [$base_route.'.destroy', $permission->id],'style'=>'display:inline']) !!}
        ...
        <div class="row">
          ...
          <div class="mb-3 col-12 col-md-6 col-lg-6">
           ...
           <div class="mb-3 col-12 col-md-6 col-lg-6">
              ...
              {!! Form::select('guard_name', $applicationtype,null, array('class'
              =>'form-control','id'=>'add_application_type','required')) !!}
              @error('guard_name')
              <div class="alert alert-danger">{{ $message }}</div>
              @enderror
          </div>
...
<div class="modal fade" id="editpermission" tabindex="-1" aria-labelledby="editpermissionLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editpermissionLabel">Edit {{$panel}}</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
       
       
       {!! Form::model($data, ['method' => 'PATCH','route' => [$base_route.'.update', empty($permission) ? 0: $permission->id]]) !!}
      <div class="modal-body">
        <div class="row">
            <div class="mb-3 col-12 col-md-6 col-lg-6">
            <label class="form-label" for="add_permission_group_name">Permission group name </label>
          ...
          <div class="mb-3 col-12 col-md-6 col-lg-6">
           ...
           <div class="mb-3 col-12 col-md-6 col-lg-6">
              ...
              {!! Form::select('guard_name', $applicationtype,null, array('class'
              =>'form-control','id'=>'edit_application_type','required')) !!}
              @error('guard_name')
              <div class="alert alert-danger">{{ $message }}</div>
              @enderror
          </div>
